...
namespace PSeatRelax가상리미터2열
{
    public partial class SystemSet : Form
    {
        ...
        private void SystemSet_Load(object sender, EventArgs e)
        {
            ...
            textBox11.Text = mControl.GetConfig.ConnectionDelay.ToString("0.00");

            checkBox2.Checked = mControl.GetConfig.AllLimit;
            return;
        }
        ...
        private void MoveSpec()
        {
            ...
            if (float.TryParse(textBox11.Text, out Config.ConnectionDelay) == false) Config.ConnectionDelay = 0;

            Config.AllLimit = checkBox2.Checked;
