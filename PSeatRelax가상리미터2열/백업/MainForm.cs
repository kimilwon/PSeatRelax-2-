...
//        }
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                if(RunningFlag == false)
                {
                    ...
                    {
                        if ((IOPort.GetStartSw == true) && (PopReadOk == true) && (IOPort.GetJigUp == true))
                        {
                            StartSetting();
                        }
                    }
                    ...
                    {
                        if ((IOPort.GetStartSw == true) &&  (IOPort.GetJigUp == true))
                        {
                            StartSetting();
                        }
                    }
        ...
        private void ScreenInit()
        {
            for(int i = 2;i < fpSpread1.ActiveSheet.RowCount;i++)
            {
                ...
                fpSpread1.ActiveSheet.Cells[i, 4].ForeColor = Color.Black;
            }
        ...
        private void RelaxCheck(short Pos)
        {
            ...
            else
            {
                ...
                if ((mSpec.RelaxLimitTime * 1000) <= (StepTimeLast - StepTimeFirst))
                {
                    ...
                    if (Pos == 1)
                    {
                        fpSpread1.ActiveSheet.Cells[3, 3].Text = (mData.Relax.Result1 == RESULT.PASS && mData.Relax.Result2 == RESULT.PASS) ? "O.K" : "N.G";
                        fpSpread1.ActiveSheet.Cells[3, 4].Text = (mData.Relax.Result1 == RESULT.PASS && mData.Relax.Result2 == RESULT.PASS) ? "O.K" : "N.G";
                        fpSpread1.ActiveSheet.Cells[3, 4].ForeColor = (mData.Relax.Result1 == RESULT.PASS && mData.Relax.Result2 == RESULT.PASS) ? Color.Green : Color.Red;
                    }
                    Step++;
                    SpecOutputFlag = false;
                    ComF.timedelay(500);
        ...
        private void ReclineCheck(short Pos)
        {
            ...
            else
            {
                ...
                if ((mSpec.ReclinerLimitTime * 1000) <= (StepTimeLast - StepTimeFirst))
                {
                    ...
                    {
                        //mData.ReclineBwd.Data = CheckData;
                        ...
                        fpSpread1.ActiveSheet.Cells[2, 3].Text = ((mData.Recline.Result1 == RESULT.PASS) && (mData.Recline.Result2 == RESULT.PASS)) ? "O.K" : "N.G";
                        fpSpread1.ActiveSheet.Cells[2, 4].Text = ((mData.Recline.Result1 == RESULT.PASS) && (mData.Recline.Result2 == RESULT.PASS)) ? "O.K" : "N.G";
                        fpSpread1.ActiveSheet.Cells[2, 4].ForeColor = ((mData.Recline.Result1 == RESULT.PASS) && (mData.Recline.Result2 == RESULT.PASS)) ? Color.Green : Color.Red;
        ...
        private void LegrestCheck(short Pos)
        {
            ...
            {
                if (Pos == 0)
                    label5.Text = "LEGREST REST 가상리미트 설정 중 입니다.";
            ...
            else
            {
                ...
                if ((mSpec.LegrestLimitTime * 1000) <= (StepTimeLast - StepTimeFirst))
                {
                    ...
                    else
                    {
                        ...
                        fpSpread1.ActiveSheet.Cells[5, 3].Text = ((mData.Legrest.Result1 == RESULT.PASS) && (mData.Legrest.Result2 == RESULT.PASS)) ? "O.K" : "N.G";
                        fpSpread1.ActiveSheet.Cells[5, 4].Text = ((mData.Legrest.Result1 == RESULT.PASS) && (mData.Legrest.Result2 == RESULT.PASS)) ? "O.K" : "N.G";
                        fpSpread1.ActiveSheet.Cells[5, 4].ForeColor = ((mData.Legrest.Result1 == RESULT.PASS) && (mData.Legrest.Result2 == RESULT.PASS)) ? Color.Green : Color.Red;
                    }
                }
        ...
        private void HeightCheck(short Pos)
        {
            ...
            {
                if (Pos == 0)
                    label5.Text = "HEIGHT UP 가상리미트 설정 중 입니다.";
                else label5.Text = "HEIGHT DN 가상리미트 설정 중 입니다.";
                StepTimeFirst = ComF.timeGetTimems();
                StepTimeLast = ComF.timeGetTimems();
                SpecOutputFlag = true;
                ...
                if(AdData < 0.5)
                {
                    ...
                    if (VirtualLimitStartFlag == true)
                    {
                        ...
                        else
                        {
                            ...
                            fpSpread1.ActiveSheet.Cells[4, 3].Text = ((mData.Height.Result1 == RESULT.PASS) && (mData.Height.Result2 == RESULT.PASS)) ? "O.K" : "N.G";
                            fpSpread1.ActiveSheet.Cells[4, 4].Text = ((mData.Height.Result1 == RESULT.PASS) && (mData.Height.Result2 == RESULT.PASS)) ? "O.K" : "N.G";
                            fpSpread1.ActiveSheet.Cells[4, 4].ForeColor = ((mData.Height.Result1 == RESULT.PASS) && (mData.Height.Result2 == RESULT.PASS)) ? Color.Green : Color.Red;
                        }
                        Step++;
                        SpecOutputFlag = false;
                        ComF.timedelay(500);
        ...
        private void LegrestExtCheck(short Pos)
        {
            ...
            {
                if (Pos == 0)
                    label5.Text = "LEGREST EXT REST 가상리미트 설정 중 입니다.";
            ...
            else
            {
                ...
                if ((mSpec.LegrestExtLimitTime * 1000) <= (StepTimeLast - StepTimeFirst))
                {
                    ...
                    else
                    {
                        ...
                        fpSpread1.ActiveSheet.Cells[6, 3].Text = ((mData.LegrestExt.Result1 == RESULT.PASS) && (mData.LegrestExt.Result2 == RESULT.PASS)) ? "O.K" : "N.G";
                        fpSpread1.ActiveSheet.Cells[6, 4].Text = ((mData.LegrestExt.Result1 == RESULT.PASS) && (mData.LegrestExt.Result2 == RESULT.PASS)) ? "O.K" : "N.G";
                        fpSpread1.ActiveSheet.Cells[6, 4].ForeColor = ((mData.LegrestExt.Result1 == RESULT.PASS) && (mData.LegrestExt.Result2 == RESULT.PASS)) ? Color.Green : Color.Red;
                    }
                }
        ...
        private void CreateDataFile()
        {
            ...
            //희터
            fpSpread2.ActiveSheet.AddSpanCell(3, Col, 1, 5);
            fpSpread2.ActiveSheet.Cells[3, Col].CellType = new FarPoint.Win.Spread.CellType.EditBaseCellType();
            fpSpread2.ActiveSheet.Cells[3, Col].VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            fpSpread2.ActiveSheet.Cells[3, Col].HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
        ...
        private void SaveInfor()
        {
            ...
            Ini.WriteInteger("COUNT", "OK", TInfor.Count.Total);
            Ini.WriteInteger("COUNT", "NG", TInfor.Count.Total);
        ...
        private void OpenInfor()
        {
            ...
            if (Ini.ReadInteger("COUNT", "OK", ref TInfor.Count.Total) == false) TInfor.Count.OK = 0;
            if (Ini.ReadInteger("COUNT", "NG", ref TInfor.Count.Total) == false) TInfor.Count.NG = 0;
