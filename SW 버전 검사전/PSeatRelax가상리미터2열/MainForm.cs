    ...
    public partial class MainForm : Form, MyInterface
    {
            ...
            try
            {
                ...
                if (RunningFlag == false)
                {
                    ...
                    if (IOPort.GetAuto == true)
                    {
                        ...
                        else if ((IOPort.GetStartSw == true) && (JigUpFlag == true) && (ProductOutFlag == true) && (label16.Text == "양품"))
                        {
                            if (IOPort.TestOKOnOff == false) IOPort.TestOKOnOff = true;
                            if (BattOnOff == true) BattOnOff = false;
                        }
                        else if ((IOPort.GetStartSw == true) && (JigUpFlag == true) && (ProductOutFlag == true) && (label16.Text == "불량"))
                        {
                ...
                if ((IOPort.GetStartSw == true) && (JigUpFlag == true) && (ProductOutFlag == true) && (label16.Text == "양품"))
                {
                    if (IOPort.TestOKOnOff == false) IOPort.TestOKOnOff = true;
                    if (BattOnOff == true) BattOnOff = false;
                }
        ...
        private void DisplaySpec()
        {
            if ((CheckItem.Recline == true) || (CheckItem.Relax == true) || (CheckItem.Height == true) || (CheckItem.Legrest == true) || (CheckItem.LegrestExt == true))
            {
                ...
                if (CheckItem.Recline == true)
                {
                    ...
                    fpSpread1.ActiveSheet.Cells[2, 3].ForeColor = Color.Yellow;
                    fpSpread1.ActiveSheet.Cells[2, 4].ForeColor = Color.White;
                }
                else
                {
                ...
                if (CheckItem.Relax == true)
                {
                    ...
                    fpSpread1.ActiveSheet.Cells[3, 3].ForeColor = Color.Yellow;
                    fpSpread1.ActiveSheet.Cells[3, 4].ForeColor = Color.White;
                }
                else
                {
                ...
                if (CheckItem.Height == true)
                {
                    ...
                    fpSpread1.ActiveSheet.Cells[4, 3].ForeColor = Color.Yellow;
                    fpSpread1.ActiveSheet.Cells[4, 4].ForeColor = Color.White;
                }
                else
                {
                ...
                if (CheckItem.Legrest == true)
                {
                    ...
                    fpSpread1.ActiveSheet.Cells[5, 3].ForeColor = Color.Yellow;
                    fpSpread1.ActiveSheet.Cells[5, 4].ForeColor = Color.White;
                }
                else
                {
                ...
                if (CheckItem.LegrestExt == true)
                {
                    ...
                    fpSpread1.ActiveSheet.Cells[6, 3].ForeColor = Color.Yellow;
                    fpSpread1.ActiveSheet.Cells[6, 4].ForeColor = Color.White;
                }
                else
                {
        ...
        private void Processing(object sender, EventArgs e)
        {
            ...
            switch (Step)
            {
                ...
                //    //if (CheckItem.Recline == true)
                //    //{
                //    //위에서 전체 리미트 설정을 동작 시켰기 때문에 아래 항목에서 동작 왼료를 검출하므로 검사 유무와 상관없이
                //    //호출된다.
                //    ReclineCheck();
                //    //}
                //    //else
                ...
                if (1000 <= (StepTimeLast - StepTimeFirst))
                {
                    ...
                    else
                    {
                        if (5000 <= (StepTimeLast - StepTimeFirst))
                        {
                            ...
                            if (CheckItem.Recline == true)
                            {
                                if ((Rl.Recline != CanMap.VirtualLimitValue.NoSetOperationAndLimitSet) && (Rr.Recline != CanMap.VirtualLimitValue.NoSetOperationAndLimitSet)) Flag = false;
                            }
                            if (CheckItem.Relax == true)
                            {
                                if ((Rl.Relax != CanMap.VirtualLimitValue.NoSetOperationAndLimitSet) && (Rr.Relax != CanMap.VirtualLimitValue.NoSetOperationAndLimitSet)) Flag = false;
                            }
                            if (CheckItem.Height == true)
                            {
                                if ((Rl.Height != CanMap.VirtualLimitValue.NoSetOperationAndLimitSet) && (Rr.Height != CanMap.VirtualLimitValue.NoSetOperationAndLimitSet)) Flag = false;
                            }
                            if (CheckItem.Legrest == true)
                            {
                                if ((Rl.Legrest != CanMap.VirtualLimitValue.NoSetOperationAndLimitSet) && (Rr.Legrest != CanMap.VirtualLimitValue.NoSetOperationAndLimitSet)) Flag = false;
                            }
                            if (CheckItem.LegrestExt == true)
                            {
                                if ((Rl.LegrestExt != CanMap.VirtualLimitValue.NoSetOperationAndLimitSet) && (Rr.LegrestExt != CanMap.VirtualLimitValue.NoSetOperationAndLimitSet)) Flag = false;
                            }
